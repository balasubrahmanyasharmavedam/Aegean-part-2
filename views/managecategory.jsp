				...
				<c:forEach items="${categoryList}" var="category">
					<tbody>
						<tr>
							<th>${category.id}</th>
							<td>${category.name}</td>
							<td><a href="edit_category/${category.id}"
								class="btn btn-xs btn-warning" role="button">Edit</a></td>
							<td><a href="delete_category/${category.id}"
								class="btn btn-xs btn-danger" role="button">Delete</a></td>
						</tr>
					</tbody>
				</c:forEach>
			</c:if>
		</table>
		<a href="addcategory" class="btn btn-lg btn-primary" role="button">Add
			a Category</a>
	</div>
	<!-- /.table-responsive -->
